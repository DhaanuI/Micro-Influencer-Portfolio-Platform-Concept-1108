...
const { FiSearch, FiFilter, FiInstagram, FiYoutube, FiTwitter, FiUsers, FiTrendingUp } = FiIcons;
...
const InfluencerGrid = () => {
  ...
  const influencers = [
    { id: 1, name: 'Sarah Johnson', category: 'lifestyle', followers: 45000, engagement: 4.2, image: 'https://images.unsplash.com/photo-1494790108755-2616b612b47c?w=400&h=400&fit=crop&crop=face', platforms: ['instagram', 'youtube'], verified: true, priceRange: '$500-1000' },
    { id: 2, name: 'Alex Chen', category: 'tech', followers: 32000, engagement: 5.1, image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face', platforms: ['youtube', 'twitter'], verified: true, priceRange: '$300-700' },
    { id: 3, name: 'Maya Patel', category: 'fashion', followers: 78000, engagement: 3.8, image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop&crop=face', platforms: ['instagram'], verified: true, priceRange: '$800-1500' },
    { id: 4, name: 'David Miller', category: 'fitness', followers: 56000, engagement: 4.7, image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face', platforms: ['instagram', 'youtube'], verified: false, priceRange: '$400-900' },
    { id: 5, name: 'Emma Wilson', category: 'food', followers: 39000, engagement: 5.3, image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop&crop=face', platforms: ['instagram', 'twitter'], verified: true, priceRange: '$350-650' },
    { id: 6, name: 'James Rodriguez', category: 'travel', followers: 67000, engagement: 4.0, image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop&crop=face', platforms: ['instagram', 'youtube'], verified: true, priceRange: '$600-1200' }
  ];
